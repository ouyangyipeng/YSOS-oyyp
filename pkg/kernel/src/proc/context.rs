...
use crate::{memory::gdt::*, RegistersValue};
...
impl ProcessContext {
    ...
    pub fn init_stack_frame(&mut self, entry: VirtAddr, stack_top: VirtAddr) {
        ...
        self.value.stack_frame.code_segment = user_selector.user_code_selector;
        self.value.stack_frame.stack_segment = user_selector.user_data_selector;
