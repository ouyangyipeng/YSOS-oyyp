...
pub const APPLIST_LENGTH: usize = 16;

/// App information
pub struct App<'a> {
    /// The name of app
    pub name: ArrayString<APPLIST_LENGTH>,
    /// The ELF file
    pub elf: ElfFile<'a>,
}

pub type AppList = ArrayVec<App<'static>, APPLIST_LENGTH>;

pub type AppListRef = Option<&'static ArrayVec<App<'static>, APPLIST_LENGTH>>;
